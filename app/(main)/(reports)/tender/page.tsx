...
export default function SupplierTenderReportGenerator() {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/reports/tender/supplier/export?date=${selectedDate}`,{
            method: 'GET',
            headers: {
            ...
            link.href = url;
            link.setAttribute('download', `Supplier_Tender_Report_${selectedDate}.xlsx`);
            ...
            <Card shadow="sm" radius="md" padding="xl" withBorder>
                <Stack align="center" gap="md" mb="xl">
                    ...
                    <Center style={{ flexDirection: 'column' }}>
                        <Title order={2}>Supplier Tender Report</Title>
                        <Text c="dimmed" size="sm" ta="center" mt="xs">
                            Generate and download the aggregated daily revenue breakdown per supplier.
                        </Text>
                    </Center>
                </Stack>
                ...
                <Stack gap="lg">
                    <Box>
                        ...
                        <SegmentedControl
                            ...
                            data={[
                                { label: 'April 10 (Day 1)', value: '2026-04-10' },
                                { label: 'April 7 (Day 2)', value: '2026-04-07' },
                                { label: 'April 8 (Day 3)', value: '2026-04-08' },
                            ]}
                            size="md"
                            color="blue"
                            fullWidth
